...
export class PizzenService {
  ...
  constructor() {
    ...
    this.pizzen.push(
     ...
     new Pizza('https://i.postimg.cc/PrxbrTTz/Funghi.jpg',15,'Pizza Funghi','mit Italienischem Parmaschinken und Rucola','14.00'),
     new Pizza('https://i.postimg.cc/5y7f4wbJ/Pizza-Prosciutto-Crudo.jpg',16,'Pizza Prosciutto Crudo','mit Italienischem Parmaschinken und Rucola','14.00'),
